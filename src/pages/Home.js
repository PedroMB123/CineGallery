...
export default function Home() {
  ...
  return (
    <ImageBackground style={styles.background} source={require("../assets/images/windows_page.jpg")} >
      ...
      <Image style={styles.icon} source={require("../assets/images/icon.png")}></Image>

      <Text style={styles.welcome}>BEM-VINDO</Text>
      <Text style={styles.subWelcome}> Seja a janela</Text>

      <TouchableOpacity style={styles.botao} onPress={() => navigation.navigate("Login")}>
        <Image style={styles.imageButton} source={require("../assets/images/cadastro_button.jpg")}></Image>
      </TouchableOpacity>
    </ImageBackground >
  );
}
